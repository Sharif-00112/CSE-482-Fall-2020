...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2020 at 03:03 PM
...
CREATE TABLE `book` (
  ...
  `b_rev` varchar(255) DEFAULT NULL
...
(5, 'mainul', 'mainulfahimnegetive@gmail.com', 'want to know your address');
...
INSERT INTO `payments` (`id`, `payment_id`, `amount`, `currency`, `payment_status`, `captured_at`) VALUES
(1, 'ch_1GN6KLFlIH472n6dMlPz1Aa4', 10.00, 'USD', 'Captured', '2020-03-16 05:57:05'),
(2, 'ch_1GN6LDFlIH472n6dMZFvPDzb', 10.00, 'USD', 'Captured', '2020-03-16 05:58:00'),
(3, 'ch_1GN6PwFlIH472n6dVtMBaggn', 60.00, 'USD', 'Captured', '2020-03-16 06:02:52');
...
(3, 'mainul fahim', ' bashundhara,dhaka.', 4000, 'dhaka', 'dhaka', 182044128, '1234'),
(4, 'mainul fahim', 'bashundhara,dhaka.', 4000, 'dhaka', 'dhaka', 182044128, '1234'),
(5, 'mainul fahim', 'bashundhara,dhaka.', 4000, 'dhaka', 'dhaka', 182044128, '1234');
...
(7, 'Mainul Fahim', 'mainul_fahim', '1234', 'Male', 'mainulfahimnegetive@gmail.com', '', 'Ahmedabad'),
(8, 'anik', 'anik_an', 'an123', 'Male', 'anik12@gmail.com', '', 'Barishal');
